...
class Videoset(Dataset):
    ...
    def __init__(self, args, mode):
        ...
        self._base_dir = path.join(self._dataset_info['base_path'], args['modality'], 'jpegs_256' if args['modality'] == 'rgb' else 'tvl1_flow')
...
if __name__ == '__main__':
    ...
    for i in range(2759, temp.__len__()):
        print(temp._X_path[i])
        a = temp.__getitem__(i)
